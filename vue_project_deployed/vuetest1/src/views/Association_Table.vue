        ...
        <div class="w3-row-padding w3-margin-bottom">
            ...
            <div class="w3-quarter">
                <div class="w3-container w3-teal w3-padding-16">
                    ...
                    <div class="w3-clear"></div>
                    <router-link :to="{path:'/association_table_full'}" @click.native="refreshrefresh"><h5>Association (Full)</h5></router-link>
                </div>
            </div>
...
<!--        <span class="button-wrap"><router-link :to="{path:'/association_table_full'}" class="button" @click.native="refreshrefresh">Click for the full table</router-link></span>-->
<!--        <span class="table-search-bar">SNP or Gene Search <input type="text" id="mySearch"  placeholder="ARSA or rs8142033"></span>-->
<!--        <span class="upload_file">***Please upload a text file with your snps separated by newline</span>-->
<!--        <br>-->
<!--        <span class="upload_file"><input type="file" id="input" @change="fileUpload">-->
...
<script>
    ...
    $(document).ready(function() {
        var table = $('#association-table').DataTable( {
            "ajax": {
                "url":"http://10.214.132.61:8181/association_table_10",
