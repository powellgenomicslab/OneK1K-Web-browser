def get_data(gene_name):
    import pandas as pd
    expression_directory = "./Samples_for_FrontEnd/"
...
def plot(gene_name):
    ...
    #      output_type='div')
    plotly.offline.plot(fig,filename="./graph_folder/index.html",auto_open=False)
...
if __name__ == '__main__':
    with open("./graph_folder/try.txt",'w') as f:
        pass
    import argparse
