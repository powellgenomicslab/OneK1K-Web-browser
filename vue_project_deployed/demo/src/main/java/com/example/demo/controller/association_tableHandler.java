...
public class association_tableHandler {
    @RequestMapping(value ="/association_table", method = RequestMethod.GET)
    @ResponseBody
    ...
    public static String getJson() {
        String jsonStr = "";
        try {
            File file = new File("//home//ranzha//website_deployment//table_data//total_association.json");
